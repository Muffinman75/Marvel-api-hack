...
function handleBackToHeroScreenClicked() {
  ...
  // $(".js-shopping-page").toggleClass("hidden", true);
  // $(".js-shopping-title").toggleClass("hidden", true);
  // $(".js-shopping-message").toggleClass("hidden", true);
  // $(".js-bio-page").toggleClass("hidden", true);
  // $(".js-video-page").toggleClass("hidden", true);
  // $(".js-video-title").toggleClass("hidden", true);
  // $(".js-choice-title").toggleClass("hidden", false);
...
function handleHeroClicked(key) {
  ...
  // $(".js-choice-page").toggleClass("hidden", true);
  // $(".js-video-title").toggleClass("hidden", false);
  // $(".js-choice-title").toggleClass("hidden", true);
  // $(".js-shopping-title").toggleClass("hidden", false);
  // $(".js-shopping-message").toggleClass("hidden", false);
}
